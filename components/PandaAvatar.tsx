  ...
  return (
    ...
    >
      ...
      >
        ...
        <circle cx="62" cy="58" r="10" fill="#E5E7EB" opacity="0.5" />
        <circle cx="138" cy="58" r="18" fill="#1a1a1a" />
        <circle cx="138" cy="58" r="10" fill="#E5E7EB" opacity="0.5" />
        ...
        {/* Blush marks */}
        <circle cx="70" cy="100" r="6" fill="#F9A8D4" opacity="0.25" />
        <circle cx="130" cy="100" r="6" fill="#F9A8D4" opacity="0.25" />
